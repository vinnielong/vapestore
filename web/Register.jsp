                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap text-center">
                                <h2 style="color: beige; font-family: 'Poppins';">Create Account</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="login_part_form">
                            <div class="login_part_form_iner">
                                ...
                                <form class="row contact_form" action="#" method="post" novalidate="novalidate">                                                               
                                    ...
                                    Address:
                                    <div class="col-md-12 form-group p_star">
                                        <input type="text" class="form-control" id="password" name="address" value=""></div><br>
                                    Phone Number:
                                    <div class="col-md-12 form-group p_star">
                                        <input type="text" class="form-control" id="password" name="phonenumber" value=""></div><br>
                                    Password:
                                    <div class="col-md-12 form-group p_star">
                                        <input type="password" class="form-control" id="password" name="pass" value=""></div><br>
                                    Re-Password:
                                    <div class="col-md-12 form-group p_star">
                                        <input type="password" class="form-control" id="password" name="repass" value=""></div><br>
